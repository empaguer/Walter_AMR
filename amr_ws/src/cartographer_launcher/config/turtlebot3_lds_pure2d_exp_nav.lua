...
options = {
  ...
  map_frame = "map",
  tracking_frame = "rs_t265_imu_optical_frame", -- imu_link, If you are using gazebo, use 'base_footprint' (libgazebo_ros_imu's bug)
...
POSE_GRAPH.optimize_every_n_nodes = 5. --90 default
